...
const FormCreateHD = () => {
  ...
  return (
    <div className="CreateHD">
          ...
          <div className="CreateHD_Form-CaNhan">
            <Form className="Form-CaNhan">
              ...
              <Form.Item label="Tên người uỷ quyền:">
                <Input type="text" name="nguoiUyQuyen" />
              </Form.Item>
          ...
          <div className="CreateHD_Form-CaNhan">
            <Form className="Form-CaNhan">
              ...
              <Form.Item label="Địa Chỉ:">
                <Input.TextArea name="DiaChiToChuc" rows={6} />
              </Form.Item>
            </Form>
          </div>
          <div className="CreateHD_Form-CaNhan">
      ...
      <ModalAddHDSuccess isOpenModal={openModalAddSuccess} isCancel={handleCancelModalSuccess}/>
    </div>
  );
};
